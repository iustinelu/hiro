...
description: Guard design-system changes in Hiro for token consistency across all four themes. Use when editing design-system gallery, ui-primitives, or ui-tokens to enforce contrast, typography, and overflow checks.
---
...
2. Validate all 4 themes (aurora/daylight/superchore/neon); themed values must be reactive via useTheme().
...
1. Name affected mobile validation targets (screens/galleries).
