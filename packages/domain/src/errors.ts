...
export const ServiceErrorCode = {
  ...
  CONTEST_WINDOW_CLOSED: "CONTEST_WINDOW_CLOSED",
  CANNOT_CONTEST_OWN: "CANNOT_CONTEST_OWN",
  NOT_CONTESTED: "NOT_CONTESTED",
  NOT_CONTESTER: "NOT_CONTESTER",
  // Expenses
