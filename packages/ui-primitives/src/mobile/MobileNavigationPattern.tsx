  ...
  return (
    <View style={{ gap: t.spacing.md }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: t.spacing.sm }}>
        ...
        <Text style={{ color: resolveColor(t, "inkMuted"), fontFamily: t.typography.fontFamily, fontSize: t.typography.titleSize, lineHeight: t.typography.lineHeightHeadline, textTransform: "uppercase", fontWeight: "800", flex: 1 }}>
          Navigation Patterns
        </Text>
      </View>
      <View style={{ borderRadius: t.radius.xl, borderWidth: 1, borderColor: resolveColor(t, "border"), backgroundColor: "rgba(11, 15, 29, 0.92)", padding: t.spacing.lg, gap: t.spacing.lg }}>
        <Text style={{ color: resolveColor(t, "inkSoft"), fontFamily: t.typography.fontFamilyMono, fontSize: t.typography.bodySmallSize, lineHeight: t.typography.lineHeightLabel }}>{activeTabLabel}</Text>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Pressable key={tab.id} onPress={() => onChange?.(tab.id)} style={{ flex: 1, alignItems: "center", gap: 8, paddingVertical: t.spacing.sm }}>
                ...
                <Text style={{ color: active ? resolveColor(t, "ink") : resolveColor(t, "inkMuted"), textTransform: "uppercase", fontFamily: t.typography.fontFamilyMono, fontSize: t.typography.bodySmallSize, lineHeight: t.typography.lineHeightLabel, textAlign: "center" }}>
                  {tab.label}
                </Text>
              </Pressable>
            );
        ...
        <View style={{ borderRadius: t.radius.lg, backgroundColor: "rgba(4, 7, 16, 0.95)", padding: t.spacing.md, borderWidth: 1, borderColor: resolveColor(t, "border"), gap: t.spacing.xs }}>
          <Text style={{ color: resolveColor(t, "accentAlt"), fontFamily: t.typography.fontFamilyMono, fontSize: t.typography.bodySmallSize, lineHeight: t.typography.lineHeightLabel }}>Indicator Logic</Text>
          <Text style={{ color: resolveColor(t, "inkMuted"), fontFamily: t.typography.fontFamily, fontSize: t.typography.bodySmallSize, lineHeight: t.typography.lineHeightBody }}>
        ...
        <View style={{ borderTopWidth: 1, borderTopColor: resolveColor(t, "accentStrong"), backgroundColor: "rgba(92, 42, 20, 0.28)", borderRadius: t.radius.md, alignItems: "center", paddingVertical: t.spacing.sm }}>
          <Text style={{ color: resolveColor(t, "accent"), fontFamily: t.typography.fontFamilyMono, fontSize: t.typography.bodySmallSize, lineHeight: t.typography.lineHeightLabel, letterSpacing: 1.4 }}>
            IOS SAFE AREA (34PT)
          </Text>
        </View>
      </View>
