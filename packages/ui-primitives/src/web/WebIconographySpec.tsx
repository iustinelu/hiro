  ...
  return (
    <section style={{ display: "grid", gap: tokens.spacing.md }}>
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <span style={{ color: resolveColor("inkSoft"), fontFamily: tokens.typography.fontFamilyMono, fontSize: tokens.typography.bodySmallSize, lineHeight: `${tokens.typography.lineHeightLabel}px` }}>SPEC_V1.2</span>
      </header>
      <div style={{ display: "grid", gap: tokens.spacing.md, gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
        <article style={{ borderRadius: tokens.radius.lg, border: `1px solid ${resolveColor("border")}`, backgroundColor: "rgba(12, 16, 30, 0.9)", padding: tokens.spacing.lg, display: "grid", gap: tokens.spacing.sm }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ color: resolveColor("inkMuted"), fontFamily: tokens.typography.fontFamilyMono, fontSize: tokens.typography.bodySmallSize, lineHeight: `${tokens.typography.lineHeightLabel}px` }}>Grid</span>
            <span style={{ color: resolveColor("accent"), fontFamily: tokens.typography.fontFamilyMono, fontSize: tokens.typography.bodySmallSize, lineHeight: `${tokens.typography.lineHeightLabel}px` }}>24px</span>
          </div>
        ...
        <article style={{ borderRadius: tokens.radius.lg, border: `1px solid ${resolveColor("border")}`, backgroundColor: "rgba(12, 16, 30, 0.9)", padding: tokens.spacing.lg, display: "grid", gap: tokens.spacing.sm }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ color: resolveColor("inkMuted"), fontFamily: tokens.typography.fontFamilyMono, fontSize: tokens.typography.bodySmallSize, lineHeight: `${tokens.typography.lineHeightLabel}px` }}>Stroke</span>
            <span style={{ color: resolveColor("accent"), fontFamily: tokens.typography.fontFamilyMono, fontSize: tokens.typography.bodySmallSize, lineHeight: `${tokens.typography.lineHeightLabel}px` }}>1.5px</span>
          </div>
