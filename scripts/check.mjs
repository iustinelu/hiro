...
const checks = [
  ...
  { name: "Versions", command: ["npm", "run", "check:versions"] },
  { name: "Migrations", command: ["npm", "run", "check:migrations"] },
  { name: "Migration Drift", command: ["npm", "run", "check:migration-drift"] },
